...
part of 'villa_sakany_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VillaSakanyModel _$VillaSakanyModelFromJson(Map<String, dynamic> json) =>
    VillaSakanyModel(
      villaData: json['data'] == null
          ? null
          : VillaData.fromJson(json['data'] as Map<String, dynamic>),
      message: json['message'] as String?,
      success: json['success'] as bool?,
    );

Map<String, dynamic> _$VillaSakanyModelToJson(VillaSakanyModel instance) =>
    <String, dynamic>{
      'data': instance.villaData,
      'message': instance.message,
      'success': instance.success,
    };

VillaData _$VillaDataFromJson(Map<String, dynamic> json) => VillaData(
...
Map<String, dynamic> _$VillaDataToJson(VillaData instance) => <String, dynamic>{
      'ads': instance.ads,
