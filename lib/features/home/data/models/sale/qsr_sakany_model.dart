...
part 'qsr_sakany_model.g.dart';
@JsonSerializable()
class QsrSakanyModel {
  @JsonKey(name: "data")
  final QsrData? qsrData;
  ...
  factory QsrSakanyModel.fromJson(Map<String, dynamic> json) => _$QsrSakanyModelFromJson(json);

  Map<String, dynamic> toJson() => _$QsrSakanyModelToJson(this);
}
...
class QsrData {
  ...
  factory QsrData.fromJson(Map<String, dynamic> json) => _$QsrDataFromJson(json);

  Map<String, dynamic> toJson() => _$QsrDataToJson(this);
}
