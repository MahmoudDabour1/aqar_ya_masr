...
part of 'aqar_momayas_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AqarMomayasModel _$AqarMomayasModelFromJson(Map<String, dynamic> json) =>
    AqarMomayasModel(
      data: json['data'] == null
          ? null
          : AqarData.fromJson(json['data'] as Map<String, dynamic>),
      message: json['message'] as String?,
      success: json['success'] as bool?,
    );

Map<String, dynamic> _$AqarMomayasModelToJson(AqarMomayasModel instance) =>
    <String, dynamic>{
      'data': instance.data,
...
AqarData _$AqarDataFromJson(Map<String, dynamic> json) => AqarData(
...
Map<String, dynamic> _$AqarDataToJson(AqarData instance) => <String, dynamic>{
      'ads': instance.ads,
...
const _$IsInstallmentEnumMap = {
  ...
  IsInstallment.PURPLE: 'يوجد تقسيط',
};
