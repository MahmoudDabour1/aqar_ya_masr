...
part "falt_sakany_rent_model.g.dart";

@JsonSerializable()
class FlatSakanyRentModel {
  @JsonKey(name: "data")
  final Data? data;
  ...
  factory FlatSakanyRentModel.fromJson(Map<String, dynamic> json) =>
      _$FlatSakanyRentModelFromJson(json);

  Map<String, dynamic> toJson() => _$FlatSakanyRentModelToJson(this);
}
