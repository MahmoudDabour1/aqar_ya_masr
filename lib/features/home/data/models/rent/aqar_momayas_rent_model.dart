...
part "aqar_momayas_rent_model.g.dart";
@JsonSerializable()
class AqarMomayasRentModel {
  @JsonKey(name: "data")
  final Data? data;
  ...
  AqarMomayasRentModel({
    this.data,
    this.message,
    this.success,
  });

  factory AqarMomayasRentModel.fromJson(Map<String, dynamic> json) => _$AqarMomayasRentModelFromJson(json);

  Map<String, dynamic> toJson() => _$AqarMomayasRentModelToJson(this);
}
