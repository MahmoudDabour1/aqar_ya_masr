...
part "villa_sakany_rent_model.g.dart";
@JsonSerializable()
class VillaSakanyRentModel {
  @JsonKey(name: "data")
  final Data? data;
  ...
  VillaSakanyRentModel({
    this.data,
    this.message,
    this.success,
  });

  factory VillaSakanyRentModel.fromJson(Map<String, dynamic> json) => _$VillaSakanyRentModelFromJson(json);

  Map<String, dynamic> toJson() => _$VillaSakanyRentModelToJson(this);
}
