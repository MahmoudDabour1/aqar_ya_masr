...
const _$ContractTypeEnumMap = {
  ContractType.CONTRACT_TYPE: 'للبيع',
  ContractType.EMPTY: 'للإيجار',
};
...
const _$CityEnumMap = {
  City.AMBITIOUS: 'السويس',
  City.BRAGGADOCIOUS: 'الدقهلية',
  City.CITY: 'الجيزة',
  City.CUNNING: 'دمياط',
  City.EMPTY: 'المنيا',
  City.FLUFFY: 'القاهرة',
  City.FRISKY: 'المنوفية',
  City.HILARIOUS: 'البحر الأحمر',
  City.INDECENT: 'جنوب سيناء',
  City.INDIGO: 'الشرقية',
  City.MAGENTA: 'الإسماعيلية',
  City.MISCHIEVOUS: 'الغربية',
  City.PURPLE: 'الإسكندرية',
  City.STICKY: 'مرسى مطروح',
  City.TENTACLED: 'القليوبية',
  City.THE_1: 'البحيرة',
  City.THE_2: 'سوهاج',
  City.THE_3: 'شمال سيناء',
};
